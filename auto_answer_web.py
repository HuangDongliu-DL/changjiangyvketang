...
class Auto_answer:
    ...
    '''
    def __init__(self,exam_id,x_access_token):
        self.x_access_token = x_access_token.split('=')[-1]
    ...
    def get_equal_rate_1(self,str1:str, str2:str) -> float:
        '''用于对比两端字符串的相似度'''
...
if __name__ == "__main__":
    a = Auto_answer("65863","eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1aWQiOjMwNjI0OTY4LCJlaWQiOjY1ODYzLCJjaWQiOiIzODMyODUxIiwiZXhwIjoxNjA4NzE2Nzk2LCJybyI6MH0.53Jku8Fmw5nqW0P01FIchN_gborvGI2yamk2D0rLE3A")
    a.Process_exam_data()